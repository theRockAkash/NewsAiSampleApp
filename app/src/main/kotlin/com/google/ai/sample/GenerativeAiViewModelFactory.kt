...
import com.google.ai.sample.feature.article.ArticleDetailViewModel
import com.google.ai.sample.feature.chat.ChatViewModel
import com.google.ai.sample.feature.multimodal.PhotoReasoningViewModel
import com.google.ai.sample.feature.news.NewsViewModel
    ...
    override fun <T : ViewModel> create(
        ...
        return with(viewModelClass) {
            when {
                ...
                isAssignableFrom(ArticleDetailViewModel::class.java) -> {
                    // Initialize a GenerativeModel with the `gemini-flash` AI model for chat
                    ArticleDetailViewModel(Repo())
                }
